...
class GIN(torch.nn.Module):
    def __init__(self, num_node_features, hidden_channels = 128, dropout = 0.0):
        ...
        mlp1 = nn.Sequential(
            nn.Linear(num_node_features, hidden_channels),  #If we remove residual connection add num_node_features at the first input 
            nn.ReLU(),
            #nn.Dropout(dropout),
